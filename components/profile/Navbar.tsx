...
const editLinkClassName = cn(
  'inline-flex items-center justify-center gap-2 rounded-full border-[2px] border-foreground bg-primary px-3 py-1 font-display text-sm font-semibold text-primary-foreground transition-all',
  'shadow-[4px_4px_0_0_hsl(var(--foreground))] hover:translate-x-[2px] hover:translate-y-[2px] hover:bg-primary/90 hover:shadow-[2px_2px_0_0_hsl(var(--foreground))]',
  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2'
);
...
export default function Navbar({
  ...
  const renderEditAction = () =>
    canEdit ? (
      <Link href={editHref} className={editLinkClassName}>
